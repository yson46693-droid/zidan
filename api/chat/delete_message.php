...
try {
    ...
    error_log('chat/delete_message bootstrap error: ' . $e->getMessage());
...
try {
    ...
    $deleted = softDeleteChatMessage($messageId, $userId);
    ...
    echo json_encode(['success' => false, 'error' => $runtime->getMessage()], JSON_UNESCAPED_UNICODE);
} catch (Throwable $e) {
    error_log('chat/delete_message error: ' . $e->getMessage());
