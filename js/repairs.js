...
<body>
    ...
    <div class="no-print">
        ...
        <button onclick="window.close()" style="padding: 10px 20px; background: #666; color: white; border: none; border-radius: 5px; cursor: pointer; margin: 10px;"><i class="bi bi-x"></i> إغلاق</button>
    </div>
</body>
</html>
        `);
