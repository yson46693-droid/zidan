...
const CACHE_NAME = 'mobile-repair-shop-v1.0.0';
const urlsToCache = [
    '/',
    '/index.html',
    '/dashboard.html',
        ...
        caches.match(event.request)
            .then(response => {
                ...
                return fetch(event.request).then(response => {
                    // لا نحفظ في الـ cache إذا لم يكن رد صحيح
            ...
            .catch(() => {
                // إذا فشل كل شيء، نعرض صفحة offline بسيطة
                return new Response(
                    '<h1 style="text-align:center;font-family:Arial;padding:50px;">لا يوجد اتصال بالإنترنت</h1>',
